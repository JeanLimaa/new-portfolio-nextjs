    ...
    return (
        <section className="home" id="home">
            <div className="home-content">
                ...
                <p>Olá, seja bem vindo ao meu Portfolio. E aqui você poderá conhecer um pouco mais sobre mim! Abaixo você irá encontrar meu Curriculo (PT-BR e EN-US) e minhas Redes Sociais para contato.</p>
