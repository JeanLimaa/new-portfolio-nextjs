        ...
        <section className="home" id="home">
            <div className="home-content">
                ...
                <div className="social-media">
                    <a target="_blank" href="https://github.com/JeanLimaa"><img src="/redes-sociais/github.svg" alt="github de jean" /></a>
                    <a target="_blank" href="https://www.linkedin.com/in/jeanlimaa/"><img src="/redes-sociais/linkedin.svg" alt="linkedin de jean" /></a>
                    <a target="_blank" href="mailto:jeansantoslima17@gmail.com"><img src="/redes-sociais/email.svg" alt="email de jean" /></a>
                </div>
